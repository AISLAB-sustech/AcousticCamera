function error = calib_func_03(g,numIterations)
...
for i = 1:numIterations
    ...
    compute_global_error_03(g);

    disp(['Performing iteration ', num2str(i)]);
    if compute_global_error_03(g)<1e-5
       disp('error is small enough, iteration ends.');
      break
   end
  % solve the dx
  [dx,H] = linearize_and_solve_with_H_03(g);
